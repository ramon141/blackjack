...
public class Player {
    ...
    //Adiciona somente uma vitória para este player
    ...
    public Player quemVenceu(Player pl){
        ...
        if(pl.soma() > 21 && this.soma() > 21){
            System.err.println("Caso esteja vendo esta mensagem o código está implementado errado");
            return null;
        }
        ...
        throw new RuntimeException("Há um erro de lógico na classe Player");
    }
    ...
    public String toString() {
        ...
        mostrar += "soma=" + soma() + ", vitoria="+getQuantVitorias()+", nome="+getNome()+"]";
